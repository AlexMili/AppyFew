package com.happyfew.happyfew.async;
...
import com.happyfew.happyfew.utils.RequestUtils;
 ...
 */
public class PostRequest extends AsyncTask<String, String, String> implements AppConfiguration{
...
Log.d(debugTag, "HERE---------------------------------------------------");
        for (String url : urls) {
            ...
            nameValuePairs.add(new BasicNameValuePair("jsonuser", ""));
